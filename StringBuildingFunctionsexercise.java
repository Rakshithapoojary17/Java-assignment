package javalabprogram3;

public class StringBuildingFunctionsexercise {
//Q1. Write a Java Program for Checking if a given string is null or contains only whitespaceusing user defined function isNullOrEmpty()
...
// Q5. Write a Java Program for Eliminating all whitespace characters from a string using userdefined function removeWhitespace()
// 5. Function to remove all whitespace from a string
		 public static String removeWhitespace(String str) {
		 return str == null ? null : str.replaceAll("\\s", "");
		 }
//Q6. Write a Java Program for Capitalizing the first letter of each word. using user definedfunction capitalizeWords()
...
//Q9. Write a Java Program for Creating a random string of a specified length using userdefined function generateRandomString()
...
// 10. Function to count words in a string
	 ...
	 public static void main(String[] args) {
		// TODO Auto-generated method stub
		 ...
		 System.out.println("1. Is Empty: " + isNullOrEmpty("")); // trueSystem.out.println("2. Occurrences: " + countOccurrences("hello hello world", "hello")); //2
		...
		// true
		 ...
		 System.out.println("9. Random String: " + generateRandomString(10)); // Random10-char string
